...
function change_images(current_theme) {
    ...
    if (current_theme == 'default') {
        try {
            document.getElementById("footer_name").setAttribute("src", "img/OdysseyInWhite.png")
        } catch(e) {
            //pass
        }
        try {
            document.getElementById("tour_footer_name").setAttribute("src", "../img/OdysseyInWhite.png")
        } catch(e) {
            //pass
        }
        //For training page: WARNING DO NOT REUSE ID
